...
ap.add_argument('-c', '--config', 
                help = 'path to yolo config file', default='cfg/yolov3-F1-10C.cfg')
ap.add_argument('-w', '--weights', 
                help = 'path to yolo pre-trained weights', default='backup/yolov3-F1-10C_20000.weights')
...
image = cv2.imread('F1_Austria/images/Race-0040.jpg')
